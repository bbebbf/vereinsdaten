...
uses System.Generics.Collections, Report.Base.Csv, Exporter.UnitMembers.Types, Exporter.Types;
...
procedure TReportUnitMembersCsv.FillFieldsToExport(const aFields: TObjectList<TReportCsvField>);
begin
  inherited;
