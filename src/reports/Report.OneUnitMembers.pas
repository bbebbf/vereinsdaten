...
uses
  ...
  Exporter.TargetIntf, Exporter.OneUnitMembers;

type
  TfmReportOneUnitMembers = class(TForm, IExporterTarget<TExporterOneUnitMembersParams>)
    RLReport: TRLReport;
...
constructor TfmReportOneUnitMembers.Create;
begin
